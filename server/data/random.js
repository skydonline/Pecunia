...
function getRandomDate(startDate, endDate) {
    ...
    return new Date(randomTimestamp).toISOString().slice(0, 10); // Format as 'YYYY-MM-DD'
}

// Modify the dates within a new range
const startDate = "2023-01-01"; // New start date
const endDate = "2023-06-31"; // New end date
...
const modifiedDataFilePath = "modified_transactions.json";
fs.writeFileSync(modifiedDataFilePath, JSON.stringify(modifiedTransactions, null, 2));
