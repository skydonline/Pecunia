        ...
        monthlyData: [
            {
                ...
                income: "$15989.64",
                expenses: "$14231.73",
                mandatoryExpenses: "$10340.03",
                nonMandatoryExpenses: "$4891.70",
            },
            {
                month: "february",
                income: "$15832.77",
                expenses: "$11677.84",
                mandatoryExpenses: "$7006.69",
                nonMandatoryExpenses: "$8661.15",
            },
            {
                month: "march",
                income: "$16481.27",
                expenses: "$14664.03",
                mandatoryExpenses: "$8797.42",
                nonMandatoryExpenses: "$7866.61",
            },
            {
                month: "april",
                income: "$18229.38",
                expenses: "$12336.52",
                mandatoryExpenses: "$7401.91",
                nonMandatoryExpenses: "$2934.61",
            },
            {
                month: "may",
                income: "$17401.79",
                expenses: "$11160.61",
                mandatoryExpenses: "$4296.37",
                nonMandatoryExpenses: "$4864.24",
            },
            {
                month: "june",
                income: "$18274.03",
                expenses: "$12311.61",
                mandatoryExpenses: "$7386.96",
                nonMandatoryExpenses: "$9924.65",
            },
            {
                month: "july",
                income: "$19349.98",
                expenses: "$15431.81",
                mandatoryExpenses: "$9258.09",
                nonMandatoryExpenses: "$7173.72",
            },
            {
                month: "august",
                income: "$16647.29",
                expenses: "$13213.71",
                mandatoryExpenses: "$3127.82",
                nonMandatoryExpenses: "$5085.89",
            },
            {
                month: "september",
                income: "$19344.07",
                expenses: "$17405.92",
                mandatoryExpenses: "$10443.55",
                nonMandatoryExpenses: "$4962.37",
            },
            {
                month: "october",
                income: "$21160.22",
                expenses: "$12990.58",
                mandatoryExpenses: "$3594.35",
                nonMandatoryExpenses: "$9396.23",
            },
            {
                month: "november",
                income: "$22655.03",
                expenses: "$17140.80",
                mandatoryExpenses: "$10284.48",
                nonMandatoryExpenses: "$3856.32",
            },
            {
                month: "december",
                income: "$17757.75",
                expenses: "$15266.97",
                mandatoryExpenses: "$9160.18",
                nonMandatoryExpenses: "$4106.79",
            },
        ],
        dailyData: [
